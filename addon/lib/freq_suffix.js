...
export const FreqSuffix = function (values, options) {
  values = values || [];
  this.node_class = FreqSuffix.TreeNode;
  this.initialize(values, options);
}

FreqSuffix.prototype = {
  max_size: null,
  split_char: ".",
  pair_counter: null,
  ...
  initialize: function (values, options) {
    ...
    this.pair_counter = new PairCounter();
    var tmp;
    if (values) {
...
FreqSuffix.TreeNode = function (key) {
  this.key = key;
  this.values = new FreqTable();
  this.nodes = {};
  this.node_type = FreqSuffix.TreeNode;
};
FreqSuffix.TreeNode.prototype = {
